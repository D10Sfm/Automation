...
# driver = webdriver.Chrome(executable_path="C:\\Users\\Dell\\Desktop\\AutoMation Subjects\\Selenium\\WebDriver(Browsers)\Chrome\\chromedriver.exe")
...
# page = driver.find_element(By.XPATH("//body/div[@id='chrome-main-content']/div[1]/main[1]/div[2]/section[1]/div[1]/div[2]"))
# if EC.invisibility_of_element(like_button):
# # use the click method to type in the element
#     like_button.click()
# else:
#     raise Exception("Element Do not found because not supported")
